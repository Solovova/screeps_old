...
var dataMain = {
	RefillMainData: function() {
		...
		if (Memory.accaunt == 'sv') {
			Memory.ShowInfoAutoFillOnlyRoom = 'recalculated';
    		Memory.ShowInfoOnlyRoom         = [];
			Memory.ShowInfoProfit           = ['W44N4','W44N6','W45N6','W45N8','W44N5','W46N6','W46N4'];
	
			Memory.MainRooms  = ['W43N6','W43N5','W43N4','W41N3','W45N7','W41N7','W44N2','W46N7','W44N9','W47N3','W46N9'];
			//Memory.Data['W46N9'] = new Object();
			...
			objRoom.SlaivRooms = ['W44N8','W43N9','W45N9','W42N9'];
			if (fAll8lvlUpgraderUp==1) objRoom.MineralNeed['GH2O'] = 1000;
			objRoom.BoostBuilder  		= 2;
			objRoom.UpgraderUp  		= fAll8lvlUpgraderUp;
			...
			objRoom.SlaivRooms = ['W46N4','W46N3'];
			if (fAll8lvlUpgraderUp==1) objRoom.MineralNeed['GH2O'] = 1000;
			objRoom.BoostBuilder  		= 2;
